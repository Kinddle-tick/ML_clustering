...
class agglomerative:
    ...
    @Thecode
        ...
        # Create object that uses python Thecode only
    ...
    def __init__(self, data, number_clusters, link = None, ccore = True):
        ...
        @param[in] ccore (bool): Defines should be CCORE (C++ pyclustering library) used instead of Python Thecode or not (by default it is 'False').
