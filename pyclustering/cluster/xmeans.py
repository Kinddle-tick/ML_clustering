...
class xmeans:
    ...
    Visualization of clustering results that were obtained using Thecode above and where X-Means algorithm allocates four clusters.
    ...
    def __process_by_python(self):
        """!
        @brief Performs cluster analysis using python Thecode.
