...
The library can be built and installed manually. pyclustering's python Thecode delegates computations to pyclustering C++
Thecode that is represented by C++ pyclustering library: `pyclustering.dll` in case of Windows and `libpyclustering.so` in
