...
def SpectralCluster_plot_clusters(data, cluster_assment, method_str):
...
if __name__ == '__main__':
    ...
    m = 200
    label_predict = SpectralClustering(data[0:m,1:],5)
    
    SpectralCluster_plot_clusters(data[0:m,1:], label_predict, 'spectrum clustering')
